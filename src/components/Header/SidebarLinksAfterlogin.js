      ...
      <div className="sidebar_main">
        <List className="side_menu">
          <ListItem className="sideItem">
            <a href="#" className="sideLink">
              <img src={require("../../assets/images/menu_icon_01.svg")} alt="Icon"/> Home
            </a>
          </ListItem>

          <ListItem className="sideItem">
            <a href="#" className="sideLink">
              <img src={require("../../assets/images/menu_icon_02.svg")} alt="Icon"/> Swap
            </a>
          </ListItem>

          <ListItem className="sideItem">
            <a href="#" className="sideLink">
              <img src={require("../../assets/images/add_pool.png")} alt="Icon"/> Add Pool
            </a>
          </ListItem>
          ...
          {/* <ListItem className="sideItem" onClick={handleClick}>
            <a href="javascript:void(0)" className="sideLink" role="button" aria-expanded="false" aria-controls="earningDropDown">
              <img src={require("../../assets/images/menu_icon_02.svg")} alt="Icon"/>Trade
          ...
          <Collapse in={!open1} timeout="auto" unmountOnExit>
            <List className="sidebarDropdown">
              <ListItem>
                <a href="#" className="sideLink">Exchange</a>
              </ListItem>
              <ListItem>
                <a href="#" className="sideLink">Liquidity</a>
              </ListItem>
            </List>
          </Collapse> */}
        
          <ListItem className="sideItem">
            <a href="https://www.ethax.io/farms" className="sideLink">
              <img src={require("../../assets/images/menu_icon_03.svg")} alt="Icon"/> Farms
            </a>
          </ListItem>

          <ListItem className="sideItem">
            <a href="https://www.ethax.io/pools" className="sideLink">
              <img src={require("../../assets/images/menu_icon_04.svg")} alt="Icon"/>Pools
            </a>
          </ListItem>          
        ...
        <div className="sidebar_footer_wrapper">
          ...
          <div className="sidebar_footer_top">
            <a href="#" className="token_stats">
              <img src={require("../../assets/images/logo_icon.png")} alt="Icon"/> <span>$9.751</span>
            </a>
            <ul className="sidebar_social_list">
              <li><a href="javascript:void(0)" target="_blank"><img src={require("../../assets/images/telegram.svg")} alt="Icon"/></a></li>
              <li><a href="javascript:void(0)" target="_blank"><img src={require("../../assets/images/twitter_icon.svg")} alt="Icon"/></a></li>
            </ul>
          </div>
